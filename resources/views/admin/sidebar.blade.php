<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('admin.add_product') }}">Add Product</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('admin.show_product') }}">Show Product</a></li>
                </ul>
            </div>
        </li>
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('admin.View_catagory') }}">
                <span class="menu-icon">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('admin.show_order') }}">
                <span class="menu-icon">
